...
<template>
    <div class="flex justify-between">
        <h1 class="text-2xl lg:text-6xl font-black text-white">Barber Racing</h1>

        <div class="flex flex-col space-y-5">
            <div class="flex gap-2 item-center">
                <p class="text-white text-right">hola: Usario</p>

                <button type="button"
                    class="bg-red-600 hover:bg-red-700 p-2 text-white uppercase text-xs font-extrabold rounded-lg">Cerrar
                    Sesión</button>
            </div>
